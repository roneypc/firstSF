...
class DefaultController extends Controller {
    ...
    public function indexAction() {
    	$params = array('mensaje' => 'Bienvenido al curso de Symfony2',
    		'fecha' => date('d-m-y'),
    		'nombre' => 'Roberto');
	...
	public function insertarAction() {
		...
		return $this->render('AlimentosBundle:Default:formInsertar.html.twig', $params);
	}
	...
	public function buscarPorNombreAction() {
		...
		return $this->render('AlimentosBundle:Default:buscarPorNombre.html.twig', $params);
	}
}
